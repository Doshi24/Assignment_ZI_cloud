  ...
  return (
    <div className="w-full max-w-3xl  p-6  ">
      ...
      <div className="mt-8">
        ...
        <div className="bg-white border  border-gray-300 rounded-lg p-6 space-y-5 shadow-sm max-h-64 overflow-y-auto">
          {/* Company Headcount */}
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">
              Company Headcount
            </label>
            <select className="w-full border  border-gray-300 rounded-md p-2 focus:ring-2 focus:ring-yellow-400 focus:outline-none">
              <option>1-10...</option>
              <option>11-50</option>
